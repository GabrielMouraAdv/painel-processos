...
const NUMERO = "0600643-18.2026.6.17.0000";
...
async function main() {
  ...
  const processo = await prisma.processoEleitoral.create({
    data: {
      ...
      apelido: "Coxa e Doquinha",
      parteAutora: "PSD",
      parteRe: "Wladimir Quirino Fernandes Rodrigues do Nascimento e outros",
      polo: "PASSIVO",
      objeto:
        "Propaganda negativa – Desinformacao – Video – Coxa e Doquinha – Medicos trabalhando sem receber",
      relator: "Luiz Gustavo Mendonca de Araujo",
