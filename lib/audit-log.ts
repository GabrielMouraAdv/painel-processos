...
export const ACOES = {
  ...
  CONECTAR_TELEGRAM: "CONECTAR_TELEGRAM",
  DESCONECTAR_TELEGRAM: "DESCONECTAR_TELEGRAM",
  TESTAR_TELEGRAM: "TESTAR_TELEGRAM",
  PREFERENCIAS_TELEGRAM: "PREFERENCIAS_TELEGRAM",
  COMANDO_TELEGRAM: "COMANDO_TELEGRAM",
  CRON_TELEGRAM: "CRON_TELEGRAM",
  INTENCAO_TELEGRAM: "INTENCAO_TELEGRAM",
  CADASTRO_VIA_TELEGRAM_LIMITE: "CADASTRO_VIA_TELEGRAM_LIMITE",
} as const;
